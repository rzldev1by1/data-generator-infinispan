...
--
-- Host: localhost    Database: gennydb
-- ------------------------------------------------------
...
CREATE TABLE `baseentity_attribute` (
  ...
  `baseEntityCode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `baseentity_attribute`
--

LOCK TABLES `baseentity_attribute` WRITE;
/*!40000 ALTER TABLE `baseentity_attribute` DISABLE KEYS */;
/*!40000 ALTER TABLE `baseentity_attribute` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-10-13  9:57:09
